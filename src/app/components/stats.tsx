  ...
  return (
    <section className="py-20 bg-surface-strong">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-y lg:divide-y-0 divide-surface-strong-foreground/15 border border-surface-strong-foreground/15">
